...
3. All operations (except for opening account) can only be performed if isActive is true. 
...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    // requestLoan, payLoan, closeAccount.
    case "openAccount":
      return {
        ...state,
        balance: 500,
    ...
    case "withdraw":
      if (state.balance === 0) return state.balance;
